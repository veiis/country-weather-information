<template>
  <div id="app">
    <div class="container">
      ...
      <div class="boxs">
        <div class="country-detail shodow">
          <h2>Country Name {{ currentCountry.name }}</h2>
          <p>
            Native Name:
        ...
        <div class="weather shodow">
          ...
          <p>
            <img src="./assets/temp.png"> Temprerature:
